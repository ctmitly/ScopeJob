    ...
    <x-card class="p-10 max-w-lg mx-auto mt-24">
        ...
        <form method="POST" action="/listings/{{$listing->id}}" enctype="=multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="location" placeholder="Example: Putrajaya, Bangi, etc" value="{{$listing->location}}" />
            ...
            <div class="mb-6">
                ...
                <img class="w-48 mr-6 mb-6" src="{{$listing->logo ? asset('storage/' . $listing->logo) : asset('/images/no_image_light.png')}}" alt=""/>
